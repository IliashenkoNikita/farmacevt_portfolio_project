...
export default async function LicenseRemindersPage({
  params,
}: {
  params: Promise<{ locale: Locale }>;
}) {
  const { locale } = await params;
  const copy = getMessages(locale).cabinet.pages.licenseReminders;
    ...
    <>
      ...
      <Card>
        ...
        <CabinetDemoActionForm
          ...
          label={copy.action}
          redirectTo={"/" + locale + "/cabinet/license-reminders"}
        />
      </Card>
    </>
  );
